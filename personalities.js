const personalities = {
   ...
   '@fuckdoxa': {
    ...
    '@sqezmoon': {
        info: 'Сквиз, начал увлекаться осинтом ещё в 23 году, однако в км пришел в августе 24 года. Создатель проекта „БЕЗНАКАЗАННОСТЬ“, Но в апреле 25 забросил проект и стал одним из администраторов „АНТИ-ДЕЛЕГАЦИЯ“. (https://t.me/+jnJGo-cOejE0MTRi) (Анти-делегация является проектом троффи). Сквиз известен стал по своим воркам',
        channel: 'https://t.me/sqezmoonbioo',
        dm: 'https://t.me/sqezmoon',
        category: 'mid',
        badge: 'badge-FAME',
        badgeText: 'сред.фейм',
        img: 'https://imgur.com/undefined.jpg'
    },
    '@n1therhovski': {
