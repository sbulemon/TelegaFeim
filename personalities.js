const personalities = {
   ...
   '@fuckdoxa': {
    ...
    '@detfears': {
        info: 'Ларинов - Пришел в КМ в далеком 2022 году, без умений, без фейма. Занимался только сн0сами аккаунтов на протяжении 2х лет.  В 2024 году я по тихоньку начал обучаться навыкам OSINT, а также практиковать. Ближе к 2025 году, начал открывать свои проекты, развиваться, обретать немного фейма. Сейчас же я открыл совместный проект с такой личностью как monolit, проект под названием «Черный Анархист» , проект уже имеет почти 900 подписчиков и идет дальше.',
