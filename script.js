...
//средный фейм ыыыыыы
    ...
    '@sharpovv': {
        info: 'Пользователь sharpovv присоединился к сообществу в Telegram в начале 2023 года. Ранее он интересовался доксингом, но вскоре понял, что это не лучший путь, и решил переключиться на программирование. Sharpovv начал изучать кодинг 4 года назад и участвовал в нескольких проектах, таких как @NoTrolls, а также запускал свой собственный проект @crazysofts, который не раз сносили на данный момент имеет нормальную узнаваемость в чатах в роле кодера. При этом его боится анонимность',
